      ...
      <div className="flex flex-col sm:flex-row gap-4">
        <div className="flex-1">
          ...
          <input
            ...
            className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent outline-none transition-all text-gray-900 bg-white"
            disabled={isLoading}
          />
        </div>
